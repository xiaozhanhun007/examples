 ...
 * FileId: CikknzJy64sUPybT877h9JjOyRTwWUJNZk4splE7fA4=
 */
package net.shopxx;
...
public class Setting implements Serializable {
	...
	private BigDecimal loginCashCoupon;
	
	@Column(nullable = false, precision = 21, scale = 6)
	private BigDecimal registerCashCoupon;
	...
	public BigDecimal getLoginCashCoupon() {
		return loginCashCoupon;
	}

	public void setLoginCashCoupon(BigDecimal loginCashCoupon) {
		this.loginCashCoupon = loginCashCoupon;
	}

	public BigDecimal getRegisterCashCoupon() {
		return registerCashCoupon;
	}

	public void setRegisterCashCoupon(BigDecimal registerCashCoupon) {
		this.registerCashCoupon = registerCashCoupon;
	}
