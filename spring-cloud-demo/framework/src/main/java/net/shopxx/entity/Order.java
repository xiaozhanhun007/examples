 ...
 * FileId: cnLvQTECdxh9mTu0yS7JpYsuGOoD0pN/d7FBd3X0H4s=
 */
...
public class Order extends BaseEntity<Long> {
	...
	public Boolean getRefundable() {
		if (!hasExpired()  
				&& (Order.Status.PENDING_SHIPMENT.equals(getStatus())
						|| Order.Status.SHIPPED.equals(getStatus()))
			...
			public boolean evaluate(Object object) {
				...
				return CollectionUtils.exists(orderItem.getAftersalesItems(), new Predicate() {
					...
					public boolean evaluate(Object object) {
						...
						return (Aftersales.Type.AFTERSALES_RETURNS.equals(aftersales.getType())
								|| Aftersales.Type.AFTERSALES_REFUND.equals(aftersales.getType()))
								&& Aftersales.Status.APPROVED.equals(aftersales.getStatus());
					}
				});
			}
		});
