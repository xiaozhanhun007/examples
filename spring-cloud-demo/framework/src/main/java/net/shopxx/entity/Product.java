 ...
 * FileId: 4gckBNDMRQnLW7ne8UVruw40PG7gj5iNUFHMiBEUCmA=
 */
...
public class Product extends BaseEntity<Long> {
	...
	public BigDecimal getSendPrice() {
		return null == sendPrice ? BigDecimal.ZERO : sendPrice;
	}
	...
	public SendProduct getSendProduct() {
		return sendProduct;
	}

	public void setSendProduct(SendProduct sendProduct) {
