...
//        final SqlMethod sqlMethod = SqlMethod.UPDATE_BY_ID;
        ...
        final String sql = String.format("<script>\nUPDATE %s %s WHERE %s=#{%s} %s\n</script>", tableInfo.getTableName(),
        ...
        return this.addUpdateMappedStatement(mapperClass, modelClass, "updateAllColumnById", sqlSource);
    }
}
