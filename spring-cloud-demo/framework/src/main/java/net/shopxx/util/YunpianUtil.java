...
public class YunpianUtil {
    ...
    private static String apikey = "98e0d7a0d8071edd6be24975b4a551fd"; // 邮箱协议类型
    private static String sign_nature="【乐返网络科技】";
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        //修改为您要发送的手机号
        //String mobile = "18665746349";
    	String mobile = "17576045869";

        /**************** 查账户信息调用示例 *****************/
        System.out.println(YunpianUtil.getUserInfo());

        /**************** 使用智能匹配模板接口发短信(推荐) *****************/
        //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
        String text = "您于2018-03-15申请重置登录密码，验证码：445034。";
        //发短信调用示例
        System.out.println(YunpianUtil.sendSms(mobile,text));
       ...
       /* long tpl_id = 1;
        ...
        //System.out.println(YunpianUtil.tplSendSms(tpl_id, tpl_value, mobile));
...
*/        //        System.out.println(JavaSmsApi.bindCall(apikey, from ,to , duration));
    ...
    */
    ...
    public static String sendSms(String mobile,String text) throws IOException {
        Map<String, String> params = new HashMap<String, String>();
        params.put("apikey", apikey);
        params.put("text", sign_nature+text);
