 ...
 * FileId: eAL1WCmIDBpngGFFHbtPQoDt5aMEdbfPD3kSW8ZMSUA=
 */
...
//	@Column(nullable = true)
	...
	@Column(length=2)
	private Integer acceptCashCoupon;
	/**
	 * 手机
	 */
	@JsonView(BaseView.class)
...
//	@Column(nullable = false)
	...
	public Integer getAcceptCashCoupon() {
		return acceptCashCoupon;
	}

	public void setAcceptCashCoupon(Integer acceptCashCoupon) {
		this.acceptCashCoupon = acceptCashCoupon;
	}
	...
	public Integer getDefaultPassword() {
		return defaultPassword;
	}

	public void setDefaultPassword(Integer defaultPassword) {
	...
	public BigDecimal getFrozenAmount() {
		return null == frozenAmount ? BigDecimal.ZERO : frozenAmount;
	}
	...
	public BigDecimal getExchangeAmount() {
		return null == exchangeAmount ? BigDecimal.ZERO : exchangeAmount;
	}
	...
	public BigDecimal getCashcoupon() {
		return null == cashcoupon ? BigDecimal.ZERO : cashcoupon;
	}
