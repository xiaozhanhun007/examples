...
public class YTADApiTest {
    ...
    public static void main(String[] args) {
        ...
        params.put("appId", "bc15916885");
        params.put("time", smft.format(new Date()));
        params.put("format", "json");
        params.put("vehicle", vehicles2);

        String result = HttpRequest.sendGetBySHA1("https://gps.xinloo.cn/monit/getVehcilePos", "02246110D671G6028A184a09A68b3af7", params);
